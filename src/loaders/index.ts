...
import { getSheetCell } from './image';
...
export { preloadImage, preloadSheet, preloadAnim, getImage, getSheet, getSheetCell, getSheetRange, getAnim } from './image';
export { preloadImageRaw, preloadSheetRaw, preloadSheetManual } from './raw';