...
import { gridPointsAroundBox, ints, relativePosition } from './util.js'
...
export function testRelativePosition() {
  let bounds = new Box(10, 20)
  bounds.setPos2(5, 10)
  assert.equal([5, 10], relativePosition(10, 20, bounds))

  bounds = new Box(10, 20)
  bounds.setPos2(5, 10)
  assert.equal([7, 3], relativePosition(12, 13, bounds))
}

export function testGridPointsAroundBox() {
  const bounds = new Box(40, 20)
  bounds.setPos2(30, 30)
  const result = gridPointsAroundBox(bounds, 10, 10)
